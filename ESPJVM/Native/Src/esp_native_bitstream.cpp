...
public:
    ...
    jint getPin() { return getFieldByIndex(2)->getInt32(); }
    int32_t *getTiming() { return ((jintArray)getFieldByIndex(3)->getObj())->getData(); }

    void setId(int32_t val) { return getFieldByIndex(1)->setInt32(val); }
    void setPin(int32_t val) { return getFieldByIndex(2)->setInt32(val); }
} *BitStreamObject;
