...
- Compatible with [`FlintJDK V1.5.0`](https://github.com/FlintVN/FlintJDK/releases/tag/V1.5.0):
  ...
  - Rename package `flint.machine` to `flint.io`.
  - Add support for `flint.io.TouchPad`.
- Use `USB Jtag` instead of `USB CDC` for debugging and disable `USB storage mode` feature in `ESP32-S2 `and `ESP32-S3`.
- Implement the native methods:
  - `FlintSocketImpl.socketSetOption`.
  - `FlintSocketImpl.socketGetOption`.
  - `FlintDatagramSocketImpl.socketSetOption`.
  - `FlintDatagramSocketImpl.socketGetOption`.
- Rename package `flint.machine` -> `flint.io` to compatible with [`FlintJDK V1.5.0`](https://github.com/FlintVN/FlintJDK/releases/tag/V1.5.0).
- Add support for `flint.io.TouchPad`.
## V0.5.0
...
- Compatible with [`FlintJDK V1.4.0`](https://github.com/FlintVN/FlintJDK/releases/tag/V1.4.0).
...
## V0.1.0
- Update to [`FlintJVM V2.2.0`](https://github.com/FlintVN/FlintJVM/releases/tag/V2.1.1) and FlintJDK to [V0.1.0](https://github.com/FlintVN/FlintJDK/releases/tag/V0.1.0):
...
## V0.0.15
- Update to base on [`FlintJVM V2.1.1`](https://github.com/FlintVN/FlintJVM/releases/tag/V2.1.1):
  - Fix stuck in `FMutex::lock` with 1 core chips.
## V0.0.14
- Update to base on [`FlintJVM V2.1.0`](https://github.com/FlintVN/FlintJVM/releases/tag/V2.1.0):
...
- Increase main default stack size to `4KB`.
